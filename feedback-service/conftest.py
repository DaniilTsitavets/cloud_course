...
os.environ.setdefault("SB_LISTEN_CONN_STR", "Endpoint=sb://test.servicebus.windows.net/;SharedAccessKeyName=k;SharedAccessKey=dGVzdA==")
os.environ.setdefault("SB_QUEUE_NAME", "test-queue")

sys.modules["pyodbc"] = MagicMock()
sys.modules["azure"] = MagicMock()
sys.modules["azure.servicebus"] = MagicMock()
sys.modules["azure.servicebus.aio"] = MagicMock()